...
Todas as organizações estão inseridas num contexto Cultural que pertence ao País ou Região e pelo modelo criado por \textit{Geer Hoftsede} Portugal tem esta distribuição das dimensões:
\begin{figure}[H]
%\fbox{

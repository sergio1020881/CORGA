...
Todas as organizações estão inseridas num contexto Cultural que pertence ao País ou Região e pelo modelo criado por \textit{Geer Hoftsede}, Portugal tem esta distribuição nas suas dimensões:
\begin{figure}[H]
...
\includegraphics[scale=0.5]{./image/OB/OC_Dimensions.jpg}

...
\\
A activadade principais de qualquer empresa é que directamente cria valor.\\
- assistencia\\
- montagem\\
- ousourcing\\
\\
...
\begin{comment}
No entanto a comparação entre os comportamentos dos liders e as cultura organizacional, no impacto que tem na variavel organização e a eficacia da liderança ainda não foram empiricamente examinados.\end{comment}
\\
...
\caption{Cultura nas Organizacões, Resultado}
\label{grafico 1}
\end{figure}\par

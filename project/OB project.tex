...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\textcolor{red}{resultados do trabalho e principais conclusões.}\\
Característica de bons Objetivos\\
- Claros\\
- Concisos\\
- Calendarizados\\
- Atingíveis\\
Criar um ambiente satisfatório e de promoção numa organização
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\vspace{15cm}\\
...
\textcolor{red}{enquadramento do trabalho, o que o leitor vai ler ao longo do trabalho, apresentacao da empresa, revisao da literatura sobre cultura organizacioanl, o odelo que vai ser usado, resultado e conclusões}\\
...
\subsection{Missão}
\begin{comment}
A missão de uma organização consiste na sua razão de existir, atual e futura.\\
\end{comment}

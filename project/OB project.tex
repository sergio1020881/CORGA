...
\qquad A disciplina \textcolor{blue}{Comportamento Organizacional} é uma ciência aplicada ao comportamento retirada de contribuições de disciplinas que estudam o comportamento, especificamente de psicologia e psicologia social, sociologia e antropologia.
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.4]{./image/OB/OB_contributions.jpg}
...
Todas as organizações estão inseridas num contexto Cultural que pertence ao País ou Região e pelo modelo criado por \textit{Geer Hoftsede} Portugal tem esta distribuição das suas dimensões:
\begin{figure}[H]
%\fbox{
\begin{minipage}{0.5\linewidth}
\flushleft
\includegraphics[scale=0.4]{./image/OB/Hofstede_pt}
\caption{Modelo Hofstede, Portugal}
\end{minipage}
\hfill
...
Método de demonstrar o desempenho de uma organizações atraves da eficacia, eficiencia e seu rendimento.\\
...
Eficiência avalia a economia de recursos utilizados para realizar os seus objectivos, requer uma boa estruturação dos processos seguidos nas actividades, o que leva tempo e custa dinheiro.\\
...
Motivar é criar condições necessárias para que as pessoas se empenham na prossecução dos objectivos da organização.\\
...
gestão das actividades é o exercício do poder de um gestor.\\
